...
#if defined(__cpp_constexpr_dynamic_alloc) && (!defined(__clang__) || __clang_major__ >= 12)
#define __cpp_lib_constexpr_string 201907L
#endif // defined(__cpp_constexpr_dynamic_alloc) && (!defined(__clang__) || __clang_major__ >= 12)
...
#if defined(__cpp_lib_constexpr_dynamic_alloc) && (!defined(__clang__) || __clang_major__ >= 12)
